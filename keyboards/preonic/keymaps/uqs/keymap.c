...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_QWER] = LAYOUT_uqs(
     ...
     /*thumb*/ LT(L_MOUSE, KC_TAB), LT_EXTD_ESC, KC_SPC,
      /*aux*/  KC_NO,    KC_LGUI,  KC_LALT,
     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINUS,
     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_BSLS,
     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,
     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,
     /*thumb*/ KC_ENT, LT_NUM_BSPC, LT_FUNC_SHIFT_INS,
  ...
  [L_EXTD] = LAYOUT_uqs(
     ...
     KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,   KC_INS,   INS_HARD,
  ...
  [L_MOUSE] = LAYOUT_uqs(
     ...
     KC_NO,    KC_NO,    KC_ACL0,  KC_ACL1,  KC_ACL2,  KC_NO,
     KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,
     /*thumb*/ _______,  _______,  _______,
      /*aux*/  _______,  _______,  _______,
               /* ^^^^ can't be used */
