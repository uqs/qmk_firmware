...
const rgblight_layer_t PROGMEM my_rgb_segments[] = {
    [L_QWER] = {{0, 20, HSV_WHITE},  RGBLIGHT_END_SEGMENTS},
    [L_WASD] = {{0, 10, HSV_RED}, {10, 10, HSV_OFF}, RGBLIGHT_END_SEGMENTS},
    [L_COLM] = {{0, 20, HSV_GREEN},  RGBLIGHT_END_SEGMENTS},
    [L_EXTD] = {{0, 20, HSV_BLUE},   RGBLIGHT_END_SEGMENTS},
    [L_NUM] =  {{0, 20, HSV_ORANGE}, RGBLIGHT_END_SEGMENTS},
    [L_FUNC] = {{0, 20, HSV_YELLOW}, RGBLIGHT_END_SEGMENTS},
    [L_MOUSE]= {{0, 20, HSV_PURPLE}, RGBLIGHT_END_SEGMENTS},
};
